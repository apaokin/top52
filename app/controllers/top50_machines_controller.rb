...
#2 END: my code
  ...
  def stats(ext = 0)
    ...
    @ratings_summary_for_js = @ratings_summary.each_with_index.map do |s, idx|
      ...
      fallback_area_color = D3_SCHEME_PAIRED[HEATMAP_TARGET_APP_AREAS.size % D3_SCHEME_PAIRED.size]
      area_colors = {}
      precedes_type_id = Top50RelationType.find_by(name_eng: "Precedes")&.id
      ...
      top_50_dates.each_with_index do |top50_date, reverse_edition_index|
        ...
        machine_ids = ranked_machine_ids_for_list(list_id, @max_rank || TOP50_MAX_RANK)
        ...
        if reverse_edition_index + 1 < top_50_dates.size
          ...
          prev_machine_ids_set = ranked_machine_ids_for_list(prev_list_id, @max_rank || TOP50_MAX_RANK).to_set if prev_list_id.present?
        end
      ...
      ordered_areas = []
      preferred_order = HEATMAP_TARGET_APP_AREAS + [fallback_area_name]
