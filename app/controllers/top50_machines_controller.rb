...
class Top50MachinesController < Top50BaseController
  ...
  def is_same(x, y)
    ...
    return metric < [x.size, y.size].max/5
  end
  ...
  def admin_links
    ...
    @objects_statuses_count[0] = 0
    @objects_statuses_count[1] = 0
    @objects_statuses_count[2] = 0

    @elems_statuses_count = Hash.new
    @elems_statuses_count[0] = 0
    @elems_statuses_count[1] = 0
    @elems_statuses_count[2] = 0
