class ExtratingsList < ActiveRecord::Base
  has_many :extratings_editions, class_name: 'ExtratingsEditions', foreign_key: 'extratings_list_id', dependent: :destroy
  has_many :extratings_list_units, foreign_key: :extratings_list_id, dependent: :destroy
