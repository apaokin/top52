...
ActiveRecord::Schema.define(version: 20250520172831) do
  ...
  create_table "extratings_editions", force: :cascade do |t|
    t.integer  "extratings_list_id", null: false
  ...
  create_table "extratings_entries", force: :cascade do |t|
    t.integer  "system_id",             null: false
    t.integer  "extratings_edition_id", null: false
    t.integer  "position"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "extratings_list_units", force: :cascade do |t|
    t.integer  "extratings_list_id", null: false
    t.integer  "extratings_unit_id", null: false
    t.integer  "priority"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "extratings_lists", force: :cascade do |t|
    t.string   "name_ru"
    t.string   "name_eng"
  ...
  create_table "extratings_scores", force: :cascade do |t|
    t.integer  "extratings_entry_id",                                null: false
    t.integer  "extratings_list_unit_id",                            null: false
    t.decimal  "score",                   precision: 100, scale: 40
    t.decimal  "normalized_score",        precision: 100, scale: 40
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "extratings_units", force: :cascade do |t|
    t.string   "name_ru"
    t.string   "name_eng"
  ...
  add_foreign_key "extratings_editions", "extratings_lists"
  add_foreign_key "extratings_entries", "extratings_editions"
  add_foreign_key "extratings_list_units", "extratings_lists"
  add_foreign_key "extratings_list_units", "extratings_units"
  add_foreign_key "extratings_scores", "extratings_entries"
  add_foreign_key "extratings_scores", "extratings_list_units"
end
